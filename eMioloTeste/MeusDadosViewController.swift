...
class MeusDadosViewController: UIViewController, UITextFieldDelegate, SendJSONDelegate, NSURLConnectionDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        usuario = Usuario(dicionario: userdefault.dictionaryRepresentation())
